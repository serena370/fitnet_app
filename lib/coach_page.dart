...
class _CoachPageState extends State<CoachPage> {
  ...
  String _buildSystemPrompt(
    ...
    double currentWeight = weights.isNotEmpty ? (weights.first['weight'] as num).toDouble() : 0;
    double height = (userData['height'] ?? 1.70).toDouble();
    double bmi = (currentWeight > 0 && height > 0) ? currentWeight / (height * height) : 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Smart AI Coach", style: TextStyle(fontWeight: FontWeight.bold)),
        actions: [
            ...
            builder: (context, weightSnap) {
              return StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, mealSnap) {
                  if (!userSnap.hasData || !weightSnap.hasData || !mealSnap.hasData) {
                  ...
                  final systemContext = _buildSystemPrompt(userData, weights, meals);
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const NutritionPage())),
                tooltip: "Log a meal",
              )
            ],
          ),
          const SizedBox(height: 8),
          const Text("I've analyzed your weight and your recent meals. How can I help you reach your goal today?",
  ...
  Widget _buildSuggestions(String context) {
    final suggestions = ["How was my diet today?", "Check my BMI status", "Analysis of my progress", "Give me a workout",  "Diet tips for weight loss"];
    return Padding(
  ...
  Widget _buildChatBubble(ChatMessage msg) {
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: msg.isUser ? Colors.blue : (isDark ? Colors.grey[800] : Colors.grey[200]),
        ...
        child: Text(
            msg.text,
            style: TextStyle(color: msg.isUser || isDark ? Colors.white : Colors.black87)
        ),
      ),
    );
  }
    ...
    return const Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 10),
          Text("AI Coach is thinking...", style: TextStyle(fontStyle: FontStyle.italic, color: Colors.grey, fontSize: 13)),
        ],
      ),
    );
  }
